...
activities = {
    ...
    # Sports activities
    "Soccer Team": {
        "description": "Competitive soccer team with seasonal matches and trainings",
        "schedule": "Mon & Wed practices 3:30 PM - 5:00 PM, games on Saturdays",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Recreational basketball training and pickup games",
